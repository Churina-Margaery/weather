...
### 3. Контракты API
Контракты API описаны в файле `API-documentation.md`.
...
Один из сценариев, покрывающих пользовательскую историю - ввод своего города в строку поиска и просмотр погоды. Реализованы тесты и других функций интерфейса (переход на гитхаб, смена темы и тд.)  
